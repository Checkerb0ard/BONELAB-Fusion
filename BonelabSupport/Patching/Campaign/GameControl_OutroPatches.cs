...
public static class GameControl_OutroPatches
{
    ...
    private static bool SendHomeEvent(byte selectionNumber, HomeEventType type)
    {
        ...
        ServerManager.SendToClientsExceptHostModule<HomeEventMessage, HomeEventData>(new HomeEventData() { Type = type, SelectionNumber = selectionNumber }, NetworkChannel.Reliable);
        return true;
    }
}
