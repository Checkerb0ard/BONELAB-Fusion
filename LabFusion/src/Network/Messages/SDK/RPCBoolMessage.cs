...
public static class RPCBoolSender
{
    public static bool SetValue(RPCBool rpcBool, bool value)
    {
        ...
        ClientManager.RelayNative(boolData, NativeMessageTag.RPCBool, CommonMessageRoutes.ReliableToClients);
    ...
    public static void CatchupValue(RPCBool rpcBool, PlayerID playerID)
    {
        ...
        ClientManager.RelayNative(boolData, NativeMessageTag.RPCBool, new MessageRoute(playerID.SmallID, NetworkChannel.Reliable));
    }
}
